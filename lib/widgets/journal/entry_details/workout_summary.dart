...
import '../../charts/dashboard_workout_config.dart';
...
class WorkoutSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<DashboardWorkoutItem> items = [];
    String workoutType = workoutEntry.data.workoutType;
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...items
              .map((DashboardWorkoutItem item) => DashboardWorkoutChart(
                    chartConfig: item,
