          ...
          return SafeArea(
            child: AutoTabsScaffold(
              ...
              appBarBuilder: (context, TabsRouter tabsRouter) {
                ...
                if ({TasksRoute.name, JournalRoute.name}
                    .contains(topRouteName)) {
                  return EmptyAppBar();
                }
                  ...
                  child: BottomNavigationBar(
                    ...
                    items: [
                      ...
                      BottomNavigationBarItem(
                        ...
                        label:
                            AppLocalizations.of(context)!.navTabTitleInsights,
                      ),
                      // TODO: bring back or remove
                      ...
                      BottomNavigationBarItem(
                        ...
                        label:
                            AppLocalizations.of(context)!.navTabTitleSettings,
                      ),
                    ],
                  ),
                );
