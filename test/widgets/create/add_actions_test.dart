...
void main() {
  ...
  group('RadialAddActionButtons Widget Tests - ', () {
    ...
    testWidgets(
      'add measurement icon visible and tappable',
      (tester) async {
        ...
        final measurementIconFinder = find.byIcon(Icons.insights);

        await tester.tap(addIconFinder);
        await tester.pumpAndSettle();

        expect(measurementIconFinder, findsOneWidget);

        await tester.tap(measurementIconFinder);
        await tester.pumpAndSettle();

        verify(
          () => mockNavService.beamToNamed(
            '/journal/measure_linked/null',
          ),
        ).called(1);
      },
    );
    ...
    testWidgets(
      'add measurement icon visible and tappable (with linked)',
      (tester) async {
        await tester.pumpWidget(
          makeTestableWidgetWithScaffold(
        ...
        verify(
          () => mockNavService.beamToNamed(
            '/journal/measure_linked/32ea936e-dfc6-43bd-8722-d816c35eb489',
          ),
        ).called(1);
      },
    );
    ...
    testWidgets(
      'add survey icon visible and tappable',
      (tester) async {
        await tester.pumpWidget(
          makeTestableWidgetWithScaffold(
            const RadialAddActionButtons(radius: 150),
        ...
        final surveyIconFinder = find.byIcon(MdiIcons.clipboardOutline);

        await tester.tap(addIconFinder);
        await tester.pumpAndSettle();

        expect(surveyIconFinder, findsOneWidget);

        await tester.tap(surveyIconFinder);
        await tester.pumpAndSettle();

        verify(
          () => mockNavService.beamToNamed(
            '/journal/fill_survey_linked/null',
          ),
        ).called(1);
      },
    );
    ...
    testWidgets(
      'add survey icon visible and tappable (with linked)',
      (tester) async {
        await tester.pumpWidget(
          makeTestableWidgetWithScaffold(
            RadialAddActionButtons(
        ...
        verify(
          () => mockNavService.beamToNamed(
            '/journal/fill_survey_linked/32ea936e-dfc6-43bd-8722-d816c35eb489',
          ),
        ).called(1);
      },
    );
