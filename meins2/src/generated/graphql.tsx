...
export type AutoCompleteQueryVariables = Exact<{ [key: string]: never }>

export type AutoCompleteQuery = { __typename?: 'QueryRoot' } & Pick<
  QueryRoot,
  'hashtags' | 'mentions'
>
...
export type OpenTasksQuery = { __typename?: 'QueryRoot' } & {
  open_tasks?: Maybe<
    Array<
      Maybe<
        { __typename?: 'Entry' } & Pick<Entry, 'timestamp' | 'md' | 'text'> & {
...
export type StartedTasksQuery = { __typename?: 'QueryRoot' } & {
  started_tasks?: Maybe<
    Array<
      Maybe<
        { __typename?: 'Entry' } & Pick<
          Entry,
          'timestamp' | 'md' | 'text' | 'completed_time'
        > & {
            comments?: Maybe<
              Array<
                Maybe<
              ...
              >
            >
            story?: Maybe<{ __typename?: 'Story' } & Pick<Story, 'story_name'>>
            task?: Maybe<
              { __typename?: 'Task' } & Pick<
                Task,
                | 'priority'
 ...
 * });
 */
export function useStartedTasksQuery(
  baseOptions?: Apollo.QueryHookOptions<
    StartedTasksQuery,
    StartedTasksQueryVariables
  >,
) {
  return Apollo.useQuery<StartedTasksQuery, StartedTasksQueryVariables>(
    StartedTasksDocument,
    baseOptions,
  )
}
export function useStartedTasksLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    StartedTasksQuery,
    StartedTasksQueryVariables
  >,
) {
  return Apollo.useLazyQuery<StartedTasksQuery, StartedTasksQueryVariables>(
    StartedTasksDocument,
    baseOptions,
  )
}
export type StartedTasksQueryHookResult = ReturnType<
  typeof useStartedTasksQuery
>
export type StartedTasksLazyQueryHookResult = ReturnType<
  typeof useStartedTasksLazyQuery
>
