...
RCT_EXPORT_METHOD(startRecorder:(NSString*)path
    ...
    [fileManager createDirectoryAtPath:audioDir withIntermediateDirectories:NO attributes:nil error:nil];
  ...
  [session setCategory:AVAudioSessionCategoryPlayAndRecord error:nil];
    ...
    [session setCategory:AVAudioSessionCategoryPlayAndRecord withOptions:session.categoryOptions|AVAudioSessionCategoryOptionAllowBluetooth
                        error:nil];
