                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    @try {
        ...
        if (uri) {
            ...
            NSURL *audioFileURL = [NSURL fileURLWithPath:[NSTemporaryDirectory() stringByAppendingString:audiofile]];
            MCOAttachment *att = [MCOAttachment attachmentWithContentsOfFile:audioFileURL.relativePath];
