...
def story_model_columns(train_x, test_x, unlabeled):
    return [
        cat_dict_column(train_x, test_x, unlabeled, 'Geohash'),
        cat_dict_column(train_x, test_x, unlabeled, 'GeohashWide'),
        cat_dict_column(train_x, test_x, unlabeled, 'Tags'),
        cat_dict_column(train_x, test_x, unlabeled, 'Mentions'),
        ...
        cat_id_column(train_x, test_x, unlabeled, 'Md'),
